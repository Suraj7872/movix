          ...
          <div className="carouselItems" ref={carouselContainer}>
            {data?.map((item) => {
              const posterUrl = item.poster_path
                ...
                : PosterFallback;
              return (
                <div key={item.id} className="carouselItem" onClick={() => navigate(`/${item?.media_type || endPoint || "tv"}/${item.id}`)}>
                  ...
                  <div className="textBlock">
                    ...
                    <span className="date">{dayjs(item.relase_Date).format('MMM D, YYYY')}</span>
                  </div>
                </div>
              );
            })}
